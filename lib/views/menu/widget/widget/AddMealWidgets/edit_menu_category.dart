...
class EditMenuCategory extends StatelessWidget {
  const EditMenuCategory({super.key, required this.currentCategory, this.refetch});
          ...
          Obx(() => GestureDetector(
            onTap: controller.isButtonActive.value
                    ...
                    final String newCategory = controller.menuCategory.text;
                         controller.updateRestaurantCategoryName("668552324409ef9c2bb165eb", currentCategory, newCategory, refetch!);
                          controller.menuCategory.text = "";
